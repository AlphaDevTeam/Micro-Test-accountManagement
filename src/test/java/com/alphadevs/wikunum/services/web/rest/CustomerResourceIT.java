...
import com.alphadevs.wikunum.services.repository.CustomerRepository;
import com.alphadevs.wikunum.services.service.criteria.CustomerCriteria;
...
class CustomerResourceIT {
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getTransactionID()).isEqualTo(DEFAULT_TRANSACTION_ID);
        assertThat(testCustomer.getLocationCode()).isEqualTo(DEFAULT_LOCATION_CODE);
        assertThat(testCustomer.getTenantCode()).isEqualTo(DEFAULT_TENANT_CODE);
    }
    ...
    void checkTransactionIDIsRequired() throws Exception {
        int databaseSizeBeforeTest = customerRepository.findAll().size();
        // set the field null
        customer.setTransactionID(null);
    ...
    @Test
    @Transactional
    void getAllCustomersByTransactionIDIsEqualToSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where transactionID equals to DEFAULT_TRANSACTION_ID
        defaultCustomerShouldBeFound("transactionID.equals=" + DEFAULT_TRANSACTION_ID);

        // Get all the customerList where transactionID equals to UPDATED_TRANSACTION_ID
        defaultCustomerShouldNotBeFound("transactionID.equals=" + UPDATED_TRANSACTION_ID);
    }

    @Test
    @Transactional
    void getAllCustomersByTransactionIDIsInShouldWork() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where transactionID in DEFAULT_TRANSACTION_ID or UPDATED_TRANSACTION_ID
        defaultCustomerShouldBeFound("transactionID.in=" + DEFAULT_TRANSACTION_ID + "," + UPDATED_TRANSACTION_ID);

        // Get all the customerList where transactionID equals to UPDATED_TRANSACTION_ID
        defaultCustomerShouldNotBeFound("transactionID.in=" + UPDATED_TRANSACTION_ID);
    }

    @Test
    @Transactional
    void getAllCustomersByTransactionIDIsNullOrNotNull() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where transactionID is not null
        defaultCustomerShouldBeFound("transactionID.specified=true");

        // Get all the customerList where transactionID is null
        defaultCustomerShouldNotBeFound("transactionID.specified=false");
    }

    @Test
    @Transactional
    void getAllCustomersByTransactionIDContainsSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where transactionID contains DEFAULT_TRANSACTION_ID
        defaultCustomerShouldBeFound("transactionID.contains=" + DEFAULT_TRANSACTION_ID);

        // Get all the customerList where transactionID contains UPDATED_TRANSACTION_ID
        defaultCustomerShouldNotBeFound("transactionID.contains=" + UPDATED_TRANSACTION_ID);
    }

    @Test
    @Transactional
    void getAllCustomersByTransactionIDNotContainsSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where transactionID does not contain DEFAULT_TRANSACTION_ID
        defaultCustomerShouldNotBeFound("transactionID.doesNotContain=" + DEFAULT_TRANSACTION_ID);

        // Get all the customerList where transactionID does not contain UPDATED_TRANSACTION_ID
        defaultCustomerShouldBeFound("transactionID.doesNotContain=" + UPDATED_TRANSACTION_ID);
    }

    @Test
    @Transactional
    void getAllCustomersByLocationCodeIsEqualToSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where locationCode equals to DEFAULT_LOCATION_CODE
        defaultCustomerShouldBeFound("locationCode.equals=" + DEFAULT_LOCATION_CODE);

        // Get all the customerList where locationCode equals to UPDATED_LOCATION_CODE
        defaultCustomerShouldNotBeFound("locationCode.equals=" + UPDATED_LOCATION_CODE);
    }

    @Test
    @Transactional
    void getAllCustomersByLocationCodeIsInShouldWork() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where locationCode in DEFAULT_LOCATION_CODE or UPDATED_LOCATION_CODE
        defaultCustomerShouldBeFound("locationCode.in=" + DEFAULT_LOCATION_CODE + "," + UPDATED_LOCATION_CODE);

        // Get all the customerList where locationCode equals to UPDATED_LOCATION_CODE
        defaultCustomerShouldNotBeFound("locationCode.in=" + UPDATED_LOCATION_CODE);
    }

    @Test
    @Transactional
    void getAllCustomersByLocationCodeIsNullOrNotNull() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where locationCode is not null
        defaultCustomerShouldBeFound("locationCode.specified=true");

        // Get all the customerList where locationCode is null
        defaultCustomerShouldNotBeFound("locationCode.specified=false");
    }

    @Test
    @Transactional
    void getAllCustomersByLocationCodeContainsSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where locationCode contains DEFAULT_LOCATION_CODE
        defaultCustomerShouldBeFound("locationCode.contains=" + DEFAULT_LOCATION_CODE);

        // Get all the customerList where locationCode contains UPDATED_LOCATION_CODE
        defaultCustomerShouldNotBeFound("locationCode.contains=" + UPDATED_LOCATION_CODE);
    }

    @Test
    @Transactional
    void getAllCustomersByLocationCodeNotContainsSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where locationCode does not contain DEFAULT_LOCATION_CODE
        defaultCustomerShouldNotBeFound("locationCode.doesNotContain=" + DEFAULT_LOCATION_CODE);

        // Get all the customerList where locationCode does not contain UPDATED_LOCATION_CODE
        defaultCustomerShouldBeFound("locationCode.doesNotContain=" + UPDATED_LOCATION_CODE);
    }

    @Test
    @Transactional
    void getAllCustomersByTenantCodeIsEqualToSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where tenantCode equals to DEFAULT_TENANT_CODE
        defaultCustomerShouldBeFound("tenantCode.equals=" + DEFAULT_TENANT_CODE);

        // Get all the customerList where tenantCode equals to UPDATED_TENANT_CODE
        defaultCustomerShouldNotBeFound("tenantCode.equals=" + UPDATED_TENANT_CODE);
    }

    @Test
    @Transactional
    void getAllCustomersByTenantCodeIsInShouldWork() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where tenantCode in DEFAULT_TENANT_CODE or UPDATED_TENANT_CODE
        defaultCustomerShouldBeFound("tenantCode.in=" + DEFAULT_TENANT_CODE + "," + UPDATED_TENANT_CODE);

        // Get all the customerList where tenantCode equals to UPDATED_TENANT_CODE
        defaultCustomerShouldNotBeFound("tenantCode.in=" + UPDATED_TENANT_CODE);
    }

    @Test
    @Transactional
    void getAllCustomersByTenantCodeIsNullOrNotNull() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where tenantCode is not null
        defaultCustomerShouldBeFound("tenantCode.specified=true");

        // Get all the customerList where tenantCode is null
        defaultCustomerShouldNotBeFound("tenantCode.specified=false");
    }

    @Test
    @Transactional
    void getAllCustomersByTenantCodeContainsSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where tenantCode contains DEFAULT_TENANT_CODE
        defaultCustomerShouldBeFound("tenantCode.contains=" + DEFAULT_TENANT_CODE);

        // Get all the customerList where tenantCode contains UPDATED_TENANT_CODE
        defaultCustomerShouldNotBeFound("tenantCode.contains=" + UPDATED_TENANT_CODE);
    }

    @Test
    @Transactional
    void getAllCustomersByTenantCodeNotContainsSomething() throws Exception {
        // Initialize the database
        customerRepository.saveAndFlush(customer);

        // Get all the customerList where tenantCode does not contain DEFAULT_TENANT_CODE
        defaultCustomerShouldNotBeFound("tenantCode.doesNotContain=" + DEFAULT_TENANT_CODE);

        // Get all the customerList where tenantCode does not contain UPDATED_TENANT_CODE
        defaultCustomerShouldBeFound("tenantCode.doesNotContain=" + UPDATED_TENANT_CODE);
    }
    ...
    void putExistingCustomer() throws Exception {
        ...
        assertThat(testCustomer.getTransactionID()).isEqualTo(UPDATED_TRANSACTION_ID);
        assertThat(testCustomer.getLocationCode()).isEqualTo(UPDATED_LOCATION_CODE);
        assertThat(testCustomer.getTenantCode()).isEqualTo(UPDATED_TENANT_CODE);
    }
