...
@RestController
@RequestMapping("/api/account-management-kafka")
public class AccountManagementKafkaResource {

    private final Logger log = LoggerFactory.getLogger(AccountManagementKafkaResource.class);
    ...
    public AccountManagementKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
