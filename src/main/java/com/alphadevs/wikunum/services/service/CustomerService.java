    ...
    public Optional<Customer> partialUpdate(Customer customer) {
        ...
        return customerRepository
            ...
            .map(existingCustomer -> {
                ...
                if (customer.getTransactionID() != null) {
                    existingCustomer.setTransactionID(customer.getTransactionID());
                }
                if (customer.getLocationCode() != null) {
                    existingCustomer.setLocationCode(customer.getLocationCode());
                }
                if (customer.getTenantCode() != null) {
                    existingCustomer.setTenantCode(customer.getTenantCode());
                }
